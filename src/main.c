...
/** instruction to send back an ECDH shared secret key */
                ...
                TRY
                    {
                        ...
                        case INS_GET_PUBLIC_KEY: {
                            ...
                            //display_public_address(publicKey.W);
                        ...
                        case INS_GET_SIGNED_PUBLIC_KEY: {
                            ...
                            if (rx < APDU_HEADER_LENGTH + 65 + BIP44_BYTE_LENGTH) {
                                hashTainted = 1;
                                THROW(0x6D09);
                            }

                            toAddress[ADDRESS_BASE58_LEN]='\0';
                            get_public_address(G_io_apdu_buffer + APDU_HEADER_LENGTH, toAddress);
